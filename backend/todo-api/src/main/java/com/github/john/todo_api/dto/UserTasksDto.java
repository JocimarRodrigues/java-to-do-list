...
public record UserTasksDto(Long id, String name, String description, StatusTask status, @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd") LocalDate createdAt) {
